...
public class Avaliacao implements Serializable {
    ...
    public String toString() {
        return "Avaliacao{" + "id=" + id + ", conceito1=" + conceito1 + ", conceito2=" + conceito2 + ", conceito3=" + conceito3 + ", conceito4=" + conceito4 + ", conceito5=" + conceito5 + ", conceito6=" + conceito6 + ", conceito7=" + conceito7 + ", conceito8=" + conceito8 + ", conceito9=" + conceito9 + ", conceito10=" + conceito10 + ", conceito11=" + conceito11 + ", conceito12=" + conceito12 + ", professor=" + professor + '}';
    }
